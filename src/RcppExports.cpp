...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(itemfitcpp(Rdata, dim, model, EMepsilon, Rtheta, Rweights, Rindividual_weights, dichotomous_data, Rclusters, Rinitial_values, verbose));
    return __result;
END_RCPP
}
// personfitcpp
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(personfitcpp(Rdata, dim, model, Rzetas, Rtheta, Rweights, method, by_individuals, dichotomous_data, Rinit_traits));
    return __result;
END_RCPP
}
